        ...
        releases.slice(0, 6).forEach(release => {
            ...
            releaseCard.innerHTML = `
                ...
                <div class="button-container flex justify-between items-center">
                    <a href="${downloadUrl}" class="download-btn ${release.prerelease ? 'download-btn-prerelease' : 'download-btn-release'}">Download</a>
                    <a href="${release.html_url}" class="github-btn ${release.prerelease ? 'github-btn-prerelease' : 'github-btn-release'}">Switch to GitHub</a>
                </div>
            `;
